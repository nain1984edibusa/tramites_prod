...
$estados=array(CONVALIDACIÓN_REQUISITOS1,CONVALIDACIÓN_REQUISITOS2);
...
$reload="/ue_bandeja_convalidacion.php";
                    ...
                    <?php while($row= mysqli_fetch_array($tramites)): 
                        ...
                        <tr <?php echo $clase; ?>>
                            ...
                            <td class="text-right">
                                ...
                                <a href="./ue_formularios_convalidacion.php?idtu=<?php echo $row["tu_id"]?>" class='btn btn-default' title='Convalidar y enviar'><i class="zmdi zmdi-rotate-ccw"></i></a>
                            </td>
                        </tr>
                    <?php endwhile;
                }else{
