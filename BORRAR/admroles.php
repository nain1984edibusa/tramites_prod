...
?>
	   <title>Vive Patrimonio - administrador</title>
						...
						<div class="container">
							<div class="col-md-9 products-left">
								<div class="error-page">
                                    ...
                                    <div>Bienvenido al sistema Vive Patrimonio</div>
   ...
   <!--   Mostrar registros de la tabla-->
      ...
      <div id="sec_contedor">
			...
			<tr><th>Id</th><th>Rol</th><th>Editar</th><th>Eliminar</th></tr>
			 <?php  
