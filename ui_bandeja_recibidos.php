...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 text-justify lead">
            Bienvenido a esta sección, en la cual se muestran todos los trámites recibidos de usuarios externos: para el proceso de <strong> validación de requisitos (1)</strong>.
        </div>
    </div>
</div>
<div class="container-fluid">
...
<div class="container-fluid">
    ...
    <div class="alert alert-info alert-dismissible" role="alert">
        <strong>Importante:</strong> Tiene <strong class="navm_bandeja_recibidos"></strong> trámites recibidos en su bandeja; revise el cumplimiento de los requisitos para proceder a enviarlos a revisión.						
