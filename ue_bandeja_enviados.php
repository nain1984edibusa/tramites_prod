...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 text-justify lead">
            Bienvenido a esta sección, en la cual se muestran todos los trámites enviados: <strong>en proceso de validación de requisitos(1) y análisis de la solicitud (2)</strong>.
        </div>
    </div>
</div>
<div class="container-fluid">
...
<div class="container-fluid">
    ...
    <div class="alert alert-warning alert-dismissible" role="alert">
        <strong>Importante:</strong> Tiene <strong class="navm_bandeja_enviados"></strong> trámites en revisión. Encontrarás un detalle de la fase en la que se encuentra y del tiempo aproximado en el cual será contestado/resuelto.						
...
<div class="container-fluid">
    <form class="col-md-8" style="" role="form" autocomplete="off">
...
?>
<script type="text/javascript" src="js/_ue_bandeja_enviados.js"></script>
