...
<div class="container-fluid">
    ...
    <div class="alert alert-warning alert-dismissible" role="alert">
        <strong>Importante:</strong> Tiene <strong class="navm_bandeja_contestados"></strong> trámites contestado. Encontrarás un detalle del trámite con enlaces de descarga de la respuesta y sus anexos en la opción "Ver detalles".						
...
?>
<script type="text/javascript" src="js/_ue_bandeja_contestados.js"></script>
