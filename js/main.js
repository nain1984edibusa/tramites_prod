$(document).ready(function(){
    ...
    $('.dropdown-menu-button').on('click', function(e){
        e.preventDefault();
        if(!$(this).hasClass('dropdown-menu-button-active')){
            $( "div" ).removeClass( "dropdown-menu-button-active" );//A1
            $( ".icon-sub-menu" ).removeClass('zmdi-chevron-up').addClass('zmdi-chevron-down');//A4
            $('.list-unstyled').attr('style', 'display:normal');//A2
        }
        ...
        //$(this).addClass('dropdown-menu-button-active');//A3
