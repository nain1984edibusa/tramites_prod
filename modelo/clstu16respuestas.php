...
Class clstu16respuestas extends clstramiterespuestas{	 
    //campos de la tabla 
    ...
    public function tuc_insertar(){
        ...
        if($bd->insertar("_ct_tramite16_respuestas")) // insertar
    ...
    public function tuc_actualizar_respuesta($actualizador){
        ...
        //$this->carga_rol_id($bd->lastID()); // sacar el siguiente registro de la tabla y lo cargo en id
        $sql= "update _ct_tramite16_respuestas set tuc_tipocontestacion='".$this->getTuc_tipo_contestacion()."',tuc_rutaarchivo='".$this->getTuc_rutaarchivo()."',tuc_infoadicional='".$this->getInfo_adicional()."', tuc_cumple='".$this->getTuc_cumple()."'".$add." WHERE tuc_id='".$this->getTuc_id()."'";
        //echo $sql;
        //exit();
        $res = $bd->ejecutar($sql);
        //$bd->cerrar();
    ...
    public function tuc_actualizar_respuesta_firma($actualizador){
        ...
        //$this->carga_rol_id($bd->lastID()); // sacar el siguiente registro de la tabla y lo cargo en id
        $sql= "update _ct_tramite16_respuestas set tuc_rutaarchivo='".$this->getTuc_rutaarchivo()."'".$add." WHERE tu_id='".$this->getTu_id()."'";
        //echo $sql;
        //exit();
        $res = $bd->ejecutar($sql);
        //$bd->cerrar();
