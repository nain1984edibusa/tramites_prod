...
while ($row=mysqli_fetch_array($sql))
	...
	?>
        ...
        <tr>
            ...
            <td style="width: 40%; text-align: left"><?php echo $nombre_producto;?></td>
...
?>
    ...
    <table>
        ...
        <?php
        $sql=mysqli_query($$_SESSION['bd_comercial'], "select * from movimientos WHERE movimientos.id_movimiento='".$id_movimiento."'");
        ...
        if(floatval($rw_factura["fp_dineroe"])>0):
        ?>
        <tr>
