...
<page backtop='38mm' backbottom='20mm' backleft='10mm' backright='10mm' footer='page' >
  <page_footer>
    ...
    <page_header>
        ...
        <h3>REPORTE GLOBAL DE COMPRAS</h3>
    </page_header>
    <p><strong>PERIODO DE ANÁLISIS</strong></p>
    <table style="width: 100%">
        <tr>
            <th style="width: 25%">Fecha Desde:</th>
            <td style="width: 25%"><?php echo $fecha_desde?></td>
            <th style="width: 25%">Fecha Hasta:</th>
            <td style="width: 25%"><?php echo $fecha_hasta?></td>
        </tr>
    </table>
    <table class="superior" cellspacing="0" style="margin-left:10%;width: 100%;font-size: 10pt;">
        <tr>
            ...
            <th style="width: 35%">NOMBRE O RAZÓN SOCIAL</th>
...
<?php 
$sql=mysqli_query($$_SESSION['bd_comercial'],"select movimientos.*,proveedores.ruc_ci,proveedores.nombre_proveedor from movimientos,proveedores where movimientos.id_proveedor=proveedores.id_proveedor and DATE(fecha_movimiento)>='".$_REQUEST["fecha_desde"]."' and DATE(fecha_movimiento)<='".$_REQUEST["fecha_hasta"]."' and proceso='COM' and factura='SI' order by fecha_movimiento,numero_factura ASC");
...
?>
        ...
        <td style="width: 15%"><?php echo $factura["numero_factura"]?></td>
        <td style="width: 35%;"><?php echo $factura["nombre_proveedor"]; ?></td>
