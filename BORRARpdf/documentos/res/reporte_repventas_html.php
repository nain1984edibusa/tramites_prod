...
td    { vertical-align: top; height:10px; padding: 5pt;}
...
<page backtop='38mm' backbottom='20mm' backleft='10mm' backright='10mm' footer='page' >
  <page_footer>
    ...
    <page_header>
        ...
        <h3>REPORTE GLOBAL DE VENTAS</h3>
    </page_header>
...
$sql=mysqli_query($$_SESSION['bd_comercial'],"select movimientos.*,clientes.ruc_ci,clientes.nombre_cliente from movimientos,clientes where movimientos.id_cliente=clientes.id_cliente and DATE(fecha_movimiento)>='".$fecha_desde."' and DATE(fecha_movimiento)<='".$fecha_hasta."' and proceso='VEN' and factura='SI' order by fecha_movimiento,numero_factura ASC");
...
?>
        ...
        <td style="width: 5%"><?php echo $sqlest["valor"]."-".$sqlfac["valor"]."-".$factura["numero_factura"]?></td>
        <td style="width: 25%;"><?php echo $factura["nombre_cliente"]; ?></td>
