<?php
	...
	$sql_factura=mysqli_query($$_SESSION['bd_comercial'],"select * from movimientos where id_movimiento='".$id_movimiento."'");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_factura_html_compra.php');
