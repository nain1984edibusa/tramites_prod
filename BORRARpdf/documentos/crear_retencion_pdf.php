<?php
    ...
    // get the HTML
        ob_start();
        include($_SERVER['DOCUMENT_ROOT'].'/syscatleia/pdf/documentos/res/ver_retencion_html_gasto.php');
    ...
    try
    {
        ...
        $html2pdf->Output($_SERVER['DOCUMENT_ROOT'].'/syscatleia/xml/docelectronicos/pdfs/r'.$autorizacion.'.pdf', 'F'); 
    }
